...
int main(int argc, char *argv[])
{
    ...
    while (!input_fifo.empty())
    {
        ...
        std::cout << "Expected: R=" << expected.R.to_string(10) << " G=" << expected.G.to_string(10) << " B=" << expected.B.to_string(10) << std::endl;
        std::cout << "Actual: R=" << out.R.to_string(10) << " G=" << out.G.to_string(10) << " B=" << out.B.to_string(10) << std::endl;
